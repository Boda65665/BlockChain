...
public class LevelDbBlock<T>{
    ...
    public void put(Block<T> block) throws IOException {
        ...
        levelDbKeysBlockStruct.put(block.getHash());
    ...
    public ArrayList<Block<T>> getAll() throws IOException {
        ...
        ArrayList<String> hashes = levelDbKeysBlockStruct.getAll();
    ...
    public static void main(String[] args) throws IOException {
        ...
        for (Block<ArrayList<Transaction>> block : levelDbBlock.getAll()) {
